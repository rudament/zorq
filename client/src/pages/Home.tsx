    ...
    <div className={pageReady ? "site-shell site-shell--ready" : "site-shell"}>
      ...
      <header className={scrolled ? "site-nav site-nav--scrolled" : "site-nav"}>
        <div className="container site-nav__inner">
          ...
          <nav className={menuOpen ? "site-nav__links site-nav__links--open" : "site-nav__links"} aria-label="Primary navigation">
            ...
            <a className="nav-cta" href="#join" onClick={closeMenu}>Join the signal <MoveUpRight size={14} /></a>
          </nav>
      ...
      <main id="top">
        <section className="hero-section" onPointerMove={handleHeroPointerMove} onPointerLeave={handleHeroPointerLeave}>
          <div className="container hero-grid">
            <div className="hero-copy" data-reveal data-visible="true">
              ...
              <div className="hero-meta">
                <span className="status-chip"><span className="status-chip__dot" />SIGNAL STATUS</span>
                <span className="hero-meta__divider" />
                <span className="hero-meta__note">Official project details pending</span>
              </div>
            </div>
          ...
          <div className="hero-bottom-line container"><span>SCROLL TO TUNE IN</span><div className="hero-bottom-line__track"><span /></div><span>ZORQ / 001</span></div>
        </section>
        ...
        <section className="why-section section-shell" id="why-zorq">
          <div className="container">
            <SectionHeading eyebrow="01 / Why Zorq" title={<>Built for the<br /><em>meme frequency.</em></>} copy="Zorq keeps the idea simple: recognizable enough to remember, refined enough to belong in the ARC ecosystem." />
        ...
        <section className="tokenomics-section section-shell" id="tokenomics">
          <div className="container">
            <SectionHeading eyebrow="02 / Tokenomics" title={<>The numbers<br /><em>come next.</em></>} copy="A clean, verified data surface is ready for the real details. Nothing here is guessed." />
